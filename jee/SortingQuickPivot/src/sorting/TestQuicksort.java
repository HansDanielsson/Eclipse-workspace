...
public class TestQuicksort {
	...
	private static int partitionMed(int[] a, int low, int high) {
		...
		/*
		 * Swap here only the elements placed at low, high and middle to obtain: the
		 * smallest placed at the position low, the highest placed at position high, the
		 * one at the middle placed at position middle
		 */
		...
		/*
		 * Once done that, swap the element at the position middle with high-1
		 */
	...
	public static void main(String[] args) {
		...
		System.out.println("***************************************");
		System.out.println(
				"Selecting as pivot the one the median between the highest, the one at the middle and the lowest position");
		System.out.println("***************************************");
