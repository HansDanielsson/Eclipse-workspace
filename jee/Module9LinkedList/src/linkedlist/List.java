...
public interface List<T> {
	...
	/**
	 * Removes the data at the specified index and returns the data that was
	 * removed.
	 * 
	...
	/**
	 * Removes the Node with the data passed in if a Node containing the data
	 * exists.
	 * 
	...
	/**
	 * Clears the LinkedList - garbage collection is your friend here. THIS SOLUTION
	 * SHOULD CAN BE O(1)
	 */
	void clear();
