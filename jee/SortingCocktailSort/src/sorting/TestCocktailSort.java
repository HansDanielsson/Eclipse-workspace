...
public class TestCocktailSort {
	...
	public static void bubbleSort(int[] a) {
		...
		System.out.println("Num Passes: " + nPasses + " Num Iter: " + nIter + " Num Swaps: " + nSwaps);
	}
	...
	public static void cocktailSort(int[] a) {
		...
		System.out.println("Num Passes: " + numPasses + " Num Iter: " + numIter + " Num Swaps: " + numSwaps);
	}
