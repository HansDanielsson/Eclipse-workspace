...
public class HtmlTag {
	...
	public boolean matches(HtmlTag other) {
		return other != null && element.equalsIgnoreCase(other.element) && openTag != other.openTag;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof HtmlTag) {
			...
			return element.equals(other.element) && openTag == other.openTag;
		}
		return false;
	}
	...
	protected static final Set<String> SELF_CLOSING_TAGS = new HashSet<>(Arrays.asList("!doctype", "!--", "?xml",
