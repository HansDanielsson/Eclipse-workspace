...
public abstract class Player implements Comparable<Player> {
	...
	public int compareTo(Player p) {
		return (susLevel < p.susLevel) ? -1 : (susLevel == p.susLevel) ? 0 : 1;
	}
	...
	/**
	 * This method tells you whether the game is over or not. You will call this
	 * method in your frozen and emergencyMeeting methods.
	 * 
