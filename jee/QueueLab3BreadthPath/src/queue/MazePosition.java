...
/**
 * Class MazePosition encapsulates the coordinates of a given position in a
 * maze.
 * 
...
public class MazePosition {
	...
	public boolean equals(Object o) {
		...
		/*
		 * Checks just the coordinates, ignores the previos position (from) so that
		 * contains detects as the same cell two positions with the same coordinates
